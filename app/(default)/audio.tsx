    ...
    return (
      <div className="text-white">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold mb-4">Audio Production</h1>
        </div>
        <div className="max-w-2xl mx-auto space-y-6">
          <p className="text-lg text-white/90 leading-relaxed">
            Transform your musical ideas into polished, professional recordings. Our comprehensive audio production services cover every stage of the creative process.
          </p>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-white/5 p-4 rounded border border-white/10">
                  <h4 className="font-bold text-white/90 mb-2">Studio Recording</h4>
                  <p className="text-white/70 text-sm">State-of-the-art equipment in acoustically treated rooms</p>
                </div>
                <div className="bg-white/5 p-4 rounded border border-white/10">
                  <h4 className="font-bold text-white/90 mb-2">Remote Recording</h4>
                  <p className="text-white/70 text-sm">Professional quality recording at your location</p>
                </div>
              </div>
            </div>
