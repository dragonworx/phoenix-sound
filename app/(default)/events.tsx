      ...
      <div className="text-white">
        ...
        <div className="max-w-2xl mx-auto space-y-6">
          <p className="text-lg text-white/90 leading-relaxed">
            Experience immersive audio environments tailored for your events.
            Our custom sound solutions create unforgettable atmospheres that
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            <div className="bg-white/5 p-6 rounded-lg border border-white/10">
              ...
              <p className="text-white/80 text-sm">
                Professional sound reinforcement and live mixing for concerts,
            ...
            <div className="bg-white/5 p-6 rounded-lg border border-white/10">
              ...
              <p className="text-white/80 text-sm">
                Permanent audio installations for galleries, museums, and
            ...
            <div className="bg-white/5 p-6 rounded-lg border border-white/10">
              ...
              <p className="text-white/80 text-sm">
                Clear, professional audio solutions for presentations and
            ...
            <div className="bg-white/5 p-6 rounded-lg border border-white/10">
              ...
              <p className="text-white/80 text-sm">
                Tailored ambient audio environments for retail, hospitality, and
                public spaces.
              </p>
            </div>
          </div>
